...
if ! id "$USERNAME" &>/dev/null; then
  ...
  # Add /usr/local/bin to the user's PATH via .bashrc and .profile
  echo 'export PATH=/usr/local/bin:$PATH' >> /home/$USERNAME/.bashrc
  echo 'export PATH=/usr/local/bin:$PATH' >> /home/$USERNAME/.profile # Add to .profile too
  chown $USERNAME:$USERNAME /home/$USERNAME/.bashrc
  chown $USERNAME:$USERNAME /home/$USERNAME/.profile # Ensure correct ownership
fi
